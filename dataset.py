...
Original file is located at
    https://colab.research.google.com/drive/1nBYVu-mJFiYzLPbsBSBNmBRo6DI5R9QI
"""
...
class DataManager(object):
    ...
    def __init__(self, dataset_name='imdb',
        ...
        if self.dataset_path is not None:
            ...
            self.dataset_path = '/kaggle/input/fer2013'
    ...
    def get_data(self,x,y):
        ...
        if self.dataset_name == 'imdb':
            ...
            ground_truth_data = self._load_fer2013(x,y)
        elif self.dataset_name == 'KDEF':
    ...
    def _load_fer2013(self,x,y):
        faces = np.expand_dims(x, -1)
        emotions = y
    ...
    def _load_KDEF(self):
        ...
        if not isinstance(self.dataset_path, str) or not self.dataset_path:
            raise ValueError("dataset_path must be a non-empty string for KDEF dataset.")
